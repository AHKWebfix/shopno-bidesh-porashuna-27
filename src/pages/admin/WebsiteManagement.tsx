...
const WebsiteManagement = () => {
  ...
  const renderHeroSection = () => <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        <div>
          ...
          <input type="text" value={heroData.title} onChange={e => setHeroData({
          ...heroData,
        ...
        <div>
          ...
          <input type="text" value={heroData.subtitle} onChange={e => setHeroData({
          ...heroData,
        ...
        <div>
          ...
          <textarea value={heroData.description} onChange={e => setHeroData({
          ...heroData,
          description: e.target.value
        })} rows={3} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-2">Primary Button Text</label>
            <input type="text" value={heroData.primaryButton} onChange={e => setHeroData({
            ...heroData,
          ...
          <div>
            ...
            <input type="text" value={heroData.secondaryButton} onChange={e => setHeroData({
            ...heroData,
  ...
  const renderServicesSection = () => <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {servicesData.map(service => <div key={service.id} className="border border-gray-200 rounded-lg p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{
              backgroundColor: service.color + '20'
            }}>
                  <School className="w-5 h-5" style={{
                color: service.color
              }} />
                </div>
                <div>
  ...
  const renderUniversitiesSection = () => <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {universitiesData.map(university => <div key={university.id} className="border border-gray-200 rounded-lg p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold" style={{
              backgroundColor: university.colorCode
            }}>
  ...
  const renderFAQSection = () => <div className="space-y-6">
      ...
      <div className="space-y-4">
        {faqData.map(faq => <div key={faq.id} className="border border-gray-200 rounded-lg p-4">
            <div className="flex items-start justify-between mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            ...
            <input type="text" value={contactData.phone1} onChange={e => setContactData({
            ...contactData,
          ...
          <div>
            ...
            <input type="text" value={contactData.phone2} onChange={e => setContactData({
            ...contactData,
          ...
          <div>
            ...
            <input type="email" value={contactData.email1} onChange={e => setContactData({
            ...contactData,
          ...
          <div>
            ...
            <input type="email" value={contactData.email2} onChange={e => setContactData({
            ...contactData,
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea value={contactData.address} onChange={e => setContactData({
            ...contactData,
          ...
          <div>
            ...
            <input type="text" value={contactData.officeHours} onChange={e => setContactData({
            ...contactData,
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input type="text" value={contactData.whatsapp} onChange={e => setContactData({
              ...contactData,
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
              ...
              <nav className="space-y-2">
                ...
                return <button key={section.id} onClick={() => setActiveSection(section.id)} className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${activeSection === section.id ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-700'}`}>
