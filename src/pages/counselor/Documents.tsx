...
const CounselorDocuments = () => {
  ...
  const documents: Document[] = [
    {
      ...
      documents: ['Passport Copy', 'Academic Transcripts', 'IELTS Certificate', 'Statement of Purpose'],
    ...
    },
    {
      ...
      documents: ['Passport Copy', 'Academic Transcripts', 'Bank Statement'],
    ...
    },
    {
      ...
      documents: ['Passport Copy', 'Academic Transcripts', 'IELTS Certificate', 'Personal Statement', 'CV'],
  ...
  return (
    <div className="p-4 lg:p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Documents</h1>
        <p className="text-gray-600">Manage student documents and submissions</p>
      </div>
              ...
              {filteredDocuments.map((doc) => (
                <tr key={doc.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-900">{doc.documents.length} documents</div>
                    <div className="text-xs text-gray-500">
                      {doc.documents.slice(0, 2).join(', ')}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                      <div 
                        ...
                        style={{ width: `${(doc.completedDocuments / doc.totalDocuments) * 100}%` }}
                      ></div>
                    </div>
                  </td>
          ...
          <div key={doc.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center justify-between text-sm text-gray-600">
                <span>Progress: {doc.completedDocuments}/{doc.totalDocuments}</span>
                <div className="flex items-center">
                  {doc.status === 'Complete' ? (
